...
if (answ1 === 'yes' || answ1 === 'y') {
    ...
    if (jobnow === 'yes' || jobnow === 'y') {
        ...
        if (cv === 'yes' || cv === 'y') { alert('i have good cv') } else { alert('i do not have a good one , i will work on it'); }
        alert('do you have a driving license?')
        let drive = prompt('enter your answer').toLowerCase();
        if (drive === 'yes' || drive === 'y') { aleart('yes i have driving license.'); } else { alert('i should take driving license soon.');  }
        alert('do you have a linkedin account?')
        let linkedin = prompt('enter your answer').toLowerCase();
        if (linkedin === 'yes' || linkedin === 'y') { alert('yes i have alinkedin account.'); } else { alert('try to sign up and have a account'); }
        alert('good luck');
    }
    else { alert('try think in your future'); alert('try think in your future'); }
}
else {
    alert('do you have job now?');
    let jobnow = prompt('enter your answer').toLowerCase();
    if (jobnow === 'yes' || jobnow === 'y') { alert('i am happy for this news ,good luck'); }
    else {
        alert('do you have a good cv?');
        let cv = prompt('enter your answer').toLowerCase()
        if (cv === 'yes' || cv === 'y') { alert('i have good cv') } else { alert('i do not have a good one , i will work on it'); }
        alert('do you have a driving license?')
        let drive = prompt('enter your answer').toLowerCase();
        if (drive === 'yes' || drive === 'y') { alert('yes i have driving license.'); } else { alert('i should take driving license');  }
        alert('do you have a linkedin account?')
        let linkedin = prompt('enter your answer').toLowerCase();
        if (linkedin === 'yes' || linkedin === 'y') { alert('yes i have alinkedin account.'); }
        else { alert('try to sign up and have a account');  }
    }
    { alert('try think in your future') }
};}
question1();
