...
if (answ1 == 'yes') 
{
    ...
    if (jobnow == 'yes') {
        ...
        if (cv == 'yes') { console.log('i have good cv') }else {alert('i do not have a good one , i will work on it');console.log('i do not have a good one , i will work on it');}
        alert('do you have a driving license?')
        let drive = prompt('enter your answer').toLowerCase();
        if (drive == 'yes') { console.log('yes i have driving license.'); }else { alert('i should take driving license soon.');console.log('i should take driving license soon.'); }
        alert('do you have a linkedin account?')
        let linkedin = prompt('enter your answer').toLowerCase();
        if (linkedin == 'yes') { console.log('yes i have alinkedin account.'); } else { alert('try to sign up and have a account');console.log('try to sign up and have a account'); }
    }
    ...
    let jobnow = prompt('enter your answer').toLowerCase();
    if (jobnow == 'yes') { console.log('i am happy for this news ,good luck'); }
    else {
        alert('do you have a good cv?');
        let cv = prompt('enter your answer').toLowerCase()
        if (cv == 'yes') { alert('i have good cv') }else {alert('i do not have a good one , i will work on it');console.log('i do not have a good one , i will work on it');}
        alert('do you have a driving license?')
        let drive = prompt('enter your answer').toLowerCase();
        if (drive == 'yes') { console.log('yes i have driving license.'); }else {alert('i should take driving license'); console.log('i should take driving license soon.') ;}
        alert('do you have a linkedin account?')
        let linkedin = prompt('enter your answer').toLowerCase();
        if (linkedin == 'yes') { console.log('yes i have alinkedin account.'); }
